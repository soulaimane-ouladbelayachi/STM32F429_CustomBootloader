...
#BL Commands
COMMAND_BL_GET_VER                                  =0x30
COMMAND_BL_GET_HELP                                 =0x31
COMMAND_BL_GET_CID                                  =0x32
COMMAND_BL_GET_RDP_STATUS                           =0x33
COMMAND_BL_GO_TO_ADDR                               =0x34
COMMAND_BL_FLASH_ERASE                              =0x35
COMMAND_BL_MEM_WRITE                                =0x36
COMMAND_BL_EN_R_W_PROTECT                           =0x37
COMMAND_BL_READ_SECTOR_P_STATUS                     =0x38
COMMAND_BL_DIS_R_W_PROTECT                          =0x39
...
ascii_name = """
 ____ ____ _  _ _    ____ _ _  _ ____ __ _ ____             ____ _  _ _    ____ ___  ___  ____ _    ____ _ _ ____ ____ _  _ _
 ==== [__] |__| |___ |--| | |\\/| |--| | \\| |=== ___ ___ ___ [__] |__| |___ |--| |__> |==] |=== |___ |--|  Y  |--| |___ |--| | 
"""
...
ascii_art = """
                 ______   _______  _______ _________ _        _______  _______  ______   _______  _______ 
                (  ___ \\ (  ___  )(  ___  )\\__   __/( \\      (  ___  )(  ___  )(  __  \\ (  ____ \\(  ____ )
                | (   ) )| (   ) || (   ) |   ) (   | (      | (   ) || (   ) || (  \\  )| (    \\/| (    )|
                | (__/ / | |   | || |   | |   | |   | |      | |   | || (___) || |   ) || (__    | (____)|
                |  __ (  | |   | || |   | |   | |   | |      | |   | ||  ___  || |   | ||  __)   |     __)
                | (  \\ \\ | |   | || |   | |   | |   | |      | |   | || (   ) || |   ) || (      | (\\ (   
                | )___) )| (___) || (___) |   | |   | (____/\\| (___) || )   ( || (__/  )| (____/\\| ) \\ \\__
                |/ \\___/ (_______)(_______)   )_(   (_______/(_______)|/     \\|(______/ (_______/|/   \\__/
...
while True:
    print("\n+================================================================================================================================================+")
    print("|                                                                   Menu                                                                         |")
    print("|                                                           STM32F429 BootLoader                                                                 |")
    print("+================================================================================================================================================+\n")
    
    print("     Which BOOTLOADER command do you want to send ?\n")
    print("                   01  - Bootloader Get Version")
    print("                   02  - Bootloader Get Help")
    print("                   03  - Bootloader Get Chip ID")
    print("                   04  - Bootloader Get Read Protection Status")
    print("                   05  - Bootloader Go to Address")
    print("                   06  - Bootloader Flash Erase")
    print("                   07  - Bootloader Memory Write")
    print("                   08  - Bootloader Enable Read Write Protection")
    print("                   09  - Bootloader Disable Read Write Protection")
    print("                   10  - Bootloader Read Sectors Protection Status")
    print("                   00  - MENU EXIT")
